...
public class GrenciadorDeSessaoTest {

	private Filme rogueOne;
	private Sala sala3D;
	private Sessao sessaoDasDez;
	private Sessao sessaoDastres;
	...
	public void PrepararSessoes() {
		...
		this.sessaoDastres = new Sessao(LocalTime.parse("13:00:00"), rogueOne, sala3D);
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesTerminadoDoHorarioDeUmaSessaoExistente() {
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesIniciandoentroDoHorarioDeUmaSessaoJaExistente() {
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
		GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessoes);
	...
	public void garanteQueNaoDevePermitirUmaInsercaoEntreDoisFilmes() {
		...
		GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessoes);
		Assert.assertTrue(gerenciador.cabe(sessaoDastres));
	}
	@Test
	public void garanteQueNaoDevePermitirUmaSessaoTermineNoProximoDia() {
